angular.module('ui.multiselect', [])
      ...
      return {
        ...
        link: function (originalScope, element, attrs, modelCtrl) {
          ...
          var exp = attrs.options,
            ...
            required = false,
            isEmpty = attrs.empty ? true : false,
          ...
          scope.$watch(function () {
              return $parse(attrs.empty)(originalScope);
            }, function (newVal) {
              isEmpty = newVal || false;
              if(!isEmpty){
            	  scope.uncheckAll();
              }
  ...
  .directive('multiselectPopup', ['$document', function ($document) {
    return {
      ...
      scope: false,
      replace: true,
      templateUrl: 'templates/private/ruleEditor/misc/multiselect.tmpl.html',
